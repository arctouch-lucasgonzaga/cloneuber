(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))e(t);new MutationObserver(t=>{for(const l of t)if(l.type==="childList")for(const n of l.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&e(n)}).observe(document,{childList:!0,subtree:!0});function o(t){const l={};return t.integrity&&(l.integrity=t.integrity),t.referrerPolicy&&(l.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?l.credentials="include":t.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function e(t){if(t.ep)return;t.ep=!0;const l=o(t);fetch(t.href,l)}})();(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const l of t.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&o(l)}).observe(document,{childList:!0,subtree:!0});function s(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function o(e){if(e.ep)return;e.ep=!0;const t=s(e);fetch(e.href,t)}})();const y=`<header class="header-menu">
  <nav class="menu">
    <ul class="menu-itens">
...
`,r="dropdown-product";function Z(){document.querySelector(`#${r}`).innerHTML=C,document.querySelector(".menu-products").addEventListener("click",()=>{document.getElementById("productsDropContent").classList.toggle("show")})}const M={componentId:r,loadComponent:Z},k=`<div class="menu-company">
...
`,v="dropdown-company";function x(){document.querySelector(`#${v}`).innerHTML=k,document.querySelector(".button-company").addEventListener("click",()=>{document.getElementById("company-content-dropdown").classList.toggle("show")})}const H={componentId:v,loadComponent:x},B=`<div class="button-language">
...
`,u="button-language";function L(){document.querySelector(`#${u}`).innerHTML=B,document.querySelector("#button-languageid").addEventListener("click",()=>{document.getElementById("fullscreen-language").classList.toggle("show-content"),document.querySelector(".buttons-language-selection").classList.toggle("button-selection-display")})}const V={componentId:u,loadComponent:L},_=`<div id="button-hamburguer">
...
`,E=`<div class="force-color content-company" id="content-company">Company</div>
...
`,p="button-company-mobile";function I(){document.querySelector(`#${p}`).innerHTML=E,document.querySelector("#content-company").addEventListener("click",()=>{document.querySelector(".lista-drop").classList.toggle("show"),document.querySelector("#button-company-mobile").classList.toggle("margin-force")})}const S={componentId:p,loadComponent:I},q=`
...
`,m="buttonLanguageMobile";function z(){document.querySelector(`#${m}`).innerHTML=P,document.querySelector("#button-language-mobile").addEventListener("click",()=>{document.getElementById("links-button").style.display="none",document.getElementById("button-products").style.display="none",document.getElementById("button-language-mobile").style.display="none",document.getElementById("fullscreen-language-mobile").classList.toggle("show-content-mobile")})}const U={componentId:m,loadComponent:z},g="button-menu-mobile";function O(){document.querySelector(`#${g}`).innerHTML=_,document.querySelector("#button-hamburguer").addEventListener("click",()=>{document.getElementById("conteudo-botao").classList.toggle("force-content"),document.getElementById("links-button").style.display="block",document.getElementById("buttonLanguageMobile").style.display="flex",document.getElementById("button-products").style.display="flex",document.getElementById("content-menu-products").style.display="none",document.getElementById("button-language-mobile").style.display="flex",document.getElementById("fullscreen-language-mobile").classList.remove("show-content-mobile"),document.getElementById("lista-drop").classList.remove("show"),document.getElementById("button-company-mobile").classList.remove("margin-force")}),S.loadComponent(),A.loadComponent(),U.loadComponent()}const $={componentId:g,loadComponent:O},f="header";function F(){document.querySelector(`#${f}`).innerHTML=y,M.loadComponent(),H.loadComponent(),V.loadComponent(),$.loadComponent()}const a={componentId:f,loadComponent:F},N=`<main class="espaco"></main>
...
`,b="main";function D(){document.querySelector(`#${b}`).innerHTML=N;let i=document.getElementById("first-input"),s=document.getElementById("second-input");i.addEventListener("click",()=>{i.classList.add("style-click")}),i.addEventListener("focusout",()=>{i.classList.remove("style-click")}),s.addEventListener("click",()=>{s.classList.add("style-click")}),s.addEventListener("focusout",()=>{s.classList.remove("style-click")})}const c={componentId:b,loadComponent:D},R=`<footer class="footer-space">
...
`,w="footer";function G(){document.querySelector(`#${w}`).innerHTML=R}const d={componentId:w,loadComponent:G};async function j(){document.querySelector("#app").innerHTML=`
    <div id="${a.componentId}"></div>
    <div id="${c.componentId}"></div>
    <div id="${d.componentId}"></div>
  `,a.loadComponent(),c.loadComponent(),d.loadComponent()}j();
